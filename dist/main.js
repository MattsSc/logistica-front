...
var MovilService = /** @class */ (function () {
    function MovilService(router, http) {
        this.router = router;
        this.http = http;
        this.httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' })
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.loadMenus = function () {
        this.menuItems = [
            { link: '/', name: Object(_biesbjerg_ngx_translate_extract_dist_utils_utils__WEBPACK_IMPORTED_MODULE_2__["_"])('home') },
        ];
    };
...
var OrdersTableComponent = /** @class */ (function () {
    function OrdersTableComponent(userService, orderService, snackBar, dialog) {
        ...
        this.snackBar = snackBar;
        this.dialog = dialog;
        this.displayedColumns = ['ordenId', 'destinatario', 'fechaRecibido', 'fechaEntregado', 'direccion', 'estado', 'acciones'];
    }
...
/*!*********************************!*\
  !*** ./src/assets/i18n/es.json ***!
  \*********************************/
/*! exports provided: companyName, ordenesTitle, orderTitle, orderFormHint, loginError, loginBtn, addOrderBtn, addBtn, cancelBtn, alreadyHaveAccBtn, createAccBtn, createAccFormBtn, createAccMsg, alreadyHaveAccMsg, notHaveOrdersMsg, createAccError, form, form-error, admin, order, orders-table, users-table, moviles-table, user-menu, acc-form, alert, anchorToHero, logisticaRavo, areYouSure, back, canVote, cancel, cannotVote, changeBrowser, create, createHero, createNewHero, cyan, details, error404, errorHasOcurred, findHero, firstTwoHeroesById, goBack, hero-create-new, hero-top, heroCreated, heroDefault, heroDetail, heroDuplicated, heroLikeMaximum, heroPower, heroRemoved, heroesList, home, language, mayTheForce, name, nameRequired, nameWithPalindrome, no, noHero, offlineMessage, orange, realName, realNameRequired, remove, removeHero, saveHero, saved, snapshot, sureRemoveHero, topHeroes, undefined, updateBrowser, yeahPalindrome, yellow, yes, default */
/***/ (function(module) {

module.exports = {"companyName":"Ravo","ordenesTitle":"Tus ordenes","orderTitle":"Orden","orderFormHint":"Quien y donde recibe:","loginError":"Usuario y/o contraseña invalida","loginBtn":"Aceptar","addOrderBtn":"Agregar orden","addBtn":"Agregar","cancelBtn":"Cancelar","alreadyHaveAccBtn":"Volver atras","createAccBtn":"Registrate","createAccFormBtn":"Crear cuenta","createAccMsg":"¿No tienes una cuenta?","alreadyHaveAccMsg":"Ya tengo una cuenta","notHaveOrdersMsg":"No posee ordenes","createAccError":"Ha habido un error, intente mas tarde","form":{"userInput":"Usuario","passInput":"Contraseña","emailInput":"E-mail","dniInput":"D.N.I.","addressInput":"Domicilio","cityInput":"Localidad/Ciudad","nameInput":"Nombre","lastnameInput":"Apellido","weightInput":"Peso (Kg.)"},"form-error":{"userInputError":"Usuario es requerido","passInputError":"Contraseña es requerida","emailInputError":"E-mail es requerido","nameInputError":"El nombre es requerido","lastnameInputError":"El apellido es requerido","dniInputError":"D.N.I. es requerido","addressInputError":"Dirección es requerido","cityInputError":"Localidad es requerido","weightInputError":"El peso es requerido"},"admin":{"title":"Dashboard","moviles":"Moviles","users":"Usuarios"},"order":{"new":"Nuevo","onWay":"En camino","delivered":"Entregado","completed":"Completado"},"orders-table":{"orderId":"Orden Id","status":"Estado","receiver":"Destinatario","address":"Dirección","deliveredDate":"Fecha de entrega","receivedDate":"Fecha  recibida"},"users-table":{"email":"Email","status":"Estado","prefix":"Prefijo"},"moviles-table":{"id":"Patente","driver":"Conductor","weight":"Peso (Kg.)"},"user-menu":{"information":"Mis datos","home":"Mis ordenes","logout":"Cerrar sesion"},"acc-form":{"loginInfoHint":"Datos de login","personalInfoHint":"Datos personales"},"alert":"Alerta","anchorToHero":"Ancla al heroe","logisticaRavo":"Logistica Ravo","areYouSure":"¿Estas seguro?","back":"Atras","canVote":"Puedes votar :)","cancel":"Cancelar","cannotVote":"No puedes votar más :(","changeBrowser":"Tu navegador no es compatible. Por favor usa Chrome, Firefox, Safari, Opera or IE>11","create":"Crear","createHero":"Añadir un heroe","createNewHero":"Crear nuevo heroe","cyan":"Cian","details":"info","error404":"Error 404","errorHasOcurred":"Ha ocurrido un error","findHero":"Busca un heroe","firstTwoHeroesById":"Heroes (1-2)","goBack":"Volver","hero-create-new":{"newHero":"Nuevo heroe"},"hero-top":{"title":"Top Heroes"},"heroCreated":"Heroe creado!","heroDefault":"Los heroes por defecto, no se pueden borrar!","heroDetail":"Detalle del heroe","heroDuplicated":"El id del heroe ya está cogido!","heroLikeMaximum":"El límite de votos es {{value}}!","heroPower":"Poder del heroe","heroRemoved":"El heroe nos ha dejado :(","heroesList":"Lista de heroes","home":"Inicio","language":"Idioma","mayTheForce":"Que la fuerza te acompañe","name":"Nombre","nameRequired":"El nombre es obligatorio","nameWithPalindrome":"Nombre (Palindrome?)","no":"No","noHero":"No hay heroe!","offlineMessage":"Sin conexión no podemos cargar nada!","orange":"Naranja","realName":"Nombre real","realNameRequired":"Nombre real es obligatorio","remove":"Eliminar","removeHero":"Eliminar heroe","saveHero":"Guardar heroe","saved":"Guardado!","snapshot":"Captura","sureRemoveHero":"¿Estas seguro de que quieres eliminar el heroe?","topHeroes":"Heroes más votados","undefined":"","updateBrowser":"Estas usando un navegador antiguo, por favor actualiza la versión y recarga la página.","yeahPalindrome":"Eso es un palindrome!","yellow":"Amarillo","yes":"Yes"};
